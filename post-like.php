<?php
/**
 * Plugin Name: CA Post Like System
 ...
 * License:
 * Original copyright notice by Jon Masterson http://jonmasterson.com/
 ...
 *
 * Mainly converted orignal code into a plugin
 */

add_action( 'plugins_loaded', array( CA_Post_Like_System::get_instance(), 'plugin_setup' ) );

class CA_Post_Like_System {
    ...
    public function get_js_file_locations() {
        return array(
            dirname( __FILE__ ) . '/js/simple-likes-public.js'
        );
    }
    ...
    public function plugin_setup() {
        ...
        /**
         * Add some global variables for javascript to access
         * @since    0.6
         */
        add_filter( 'carnation_js_global_vars', array( &$this, 'simple_likes_js_global_vars' ), 10, 1 );
         ...
         * @since    0.5
         */
        add_shortcode( 'jmliker', array( &$this, 'sl_shortcode' ) );

        /**
         * Add info on user's likes in User Profile List
         * @since    0.5
         */
    ...
    function sl_enqueue_scripts() {
        wp_enqueue_style( 'simple-likes-public-css', $this->plugin_url . '/css/simple-likes-public.css', null, '0.5', 'all' );
    }
     ...
     * @since 0.6
     *
     * @param array $vars  An associative array of variable names and values
     * @return array $vars
     */
    function simple_likes_js_global_vars( $vars ) {
        $vars['simpleLikes'] = array(
    ...
    function show_user_likes( $user ) { ?>
        <table class="form-table">
            <tr>
                <th><label for="user_likes"><?php _e( 'You Like:', 'ca' ); ?></label></th>
                <td>
                <?php
                ...
                <?php else : ?>
                <p><?php _e( 'You do not like anything yet.', 'ca' ); ?></p>
                <?php 
                endif; 
                wp_reset_postdata(); 
                ?>
